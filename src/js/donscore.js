...
export function convertToDonscore(chart, courseId) {
	...
	result.push(`;converted by TJA Tools <https://whmhammer.github.io/tja-tools>`); // default URL to replace in GitHub action. Please keep this URL the same as the URL in the GitHub action
